...
function insert_histories($db, $user_id, $total_price){
  $sql = "
    INSERT INTO
      histories(
        user_id,
...
function insert_history_details($db, $history_id, $item_id, $purchase_price, $amount){
  $sql = "
    INSERT INTO
      history_details(
        history_id,
    ...
    VALUES(?, ?, ?, ?)
  ";
  return execute_query($db, $sql, [$history_id, $item_id, $purchase_price, $amount]);
}
